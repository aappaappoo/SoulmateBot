...
# Import configuration data from strategy_config module
from . import strategy_config

# Import EMOTION_KEYWORDS which doesn't depend on enums
EMOTION_KEYWORDS = strategy_config.EMOTION_KEYWORDS

# Construct configuration dictionaries using enums defined above
STRATEGY_TEMPLATES = strategy_config._get_strategy_templates(ResponseType)
